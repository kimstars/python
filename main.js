    ...
    "data": {
        "__schema": {
            ...
            "types": [{
                ...
                "kind": "OBJECT",
                "name": "NoteObjectEdge",
                "description": "A Relay edge containing a `NoteObject` and its cursor.",
                "fields": [{
                    "name": "node",
                ...
                "kind": "OBJECT",
                "name": "UserObjectEdge",
                "description": "A Relay edge containing a `UserObject` and its cursor.",
                "fields": [{
                    "name": "node",
                    "description": "The item at the end of the edge",
                    "args": [],
